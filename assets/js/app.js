...
const sttaddr = "0x3b19bdc90a52480f874121f7dc55156bc82c46ba";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x3b19bdc90a52480f874121f7dc55156bc82c46ba";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://genetoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x3b19bdc90a52480f874121f7dc55156bc82c46ba',
                    'symbol': 'GENA',
                    'decimals': '18',
                    'image': 'https://genetoken.net/images/logo.png',
                },
            },
